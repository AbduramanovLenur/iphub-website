...
var accordion = function accordion(triggesrSelector) {
  var triggesSelector = document.querySelectorAll(triggesrSelector);
  if (!triggesSelector) return;
  triggesSelector.forEach(function (element) {
    element.addEventListener('click', function () {
      ...
      if (this.classList.contains('is-active')) {
        ...
        this.nextElementSibling.style.maxHeight = "".concat(this.nextElementSibling.scrollHeight, "px");
      } else {
...
/***/ "./src/js/modules/filter-select.js":
/*!*****************************************!*\
  !*** ./src/js/modules/filter-select.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var filterSelect = function filterSelect(parentSelector, contentSelctor) {
  var parentSelect = document.querySelector(parentSelector);
  var filterServices = document.querySelectorAll(contentSelctor);
  if (!parentSelect) return;
  parentSelect.addEventListener('change', selectValueHandler);

  function selectValueHandler() {
    var value = parentSelect.value;
    filterServices.forEach(function (elem) {
...
var filter = function filter(filterParentSelector, filterContentSelector, filterBtnSelector) {
  var filterParent = document.querySelector(filterParentSelector);
  var filterServices = document.querySelectorAll(filterContentSelector);
  var filterBtn = document.querySelectorAll(filterBtnSelector);
  ...
  filterParent.addEventListener('click', function (event) {
    ...
    var filterClass = event.target.closest('[data-js-s]').dataset.jsS;
...
var imask = function imask(inputSelector, maskNumbers) {
  var inputsImask = document.querySelectorAll(inputSelector);
  if (!inputsImask) return;
  inputsImask.forEach(function (inputsImask) {
    (0,imask__WEBPACK_IMPORTED_MODULE_2__["default"])(inputsImask, {
      mask: maskNumbers
    });
  });
};
...
var modal = function modal(modalSelector, modalBtnSelector, modalCloseSelector) {
  try {
    var modalCloseHandler = function modalCloseHandler(event) {
    ...
    var keydownCloseHandler = function keydownCloseHandler(event) {
      if (event.code === 'Escape' && _modal.classList.contains('is-active')) {
        closeModal();
      }
    ...
    var btns = document.querySelectorAll(modalBtnSelector);
    var close = document.querySelector(modalCloseSelector);
    if (!_modal) return;

    _modal.addEventListener('click', modalCloseHandler);
...
var search = function search(inputSelector, servicesSelector) {
  var input = document.querySelector(inputSelector);
  var services = document.querySelectorAll(servicesSelector);
  if (!input) return;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var swiperSlider = function swiperSlider(swiperSelector, objSwiper) {
  var element = document.querySelector(swiperSelector);
  if (!element) return;
...
var tab = function tab(tabContentSelector, tabBtnsSelector, tabParentSelector) {
  var tabContent = document.querySelectorAll(tabContentSelector);
  var tabTrigger = document.querySelectorAll(tabBtnsSelector);
  ...
  function hideTabContent() {
    ...
    tabTrigger.forEach(function (btn) {
  ...
  function tabShowContentHandler(e) {
    ...
    if (target && target.classList.contains('teams__content-btn')) {
      tabTrigger.forEach(function (btn, i) {
        if (target === btn) {
          hideTabContent();
          showTabContent(i);
        }
...
/* harmony import */ var _modules_imask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/imask */ "./src/js/modules/imask.js");
...
/* harmony import */ var _modules_filter_select__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/filter-select */ "./src/js/modules/filter-select.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["default"])('.swiper-solution', {
    navigation: {
  ...
  (0,_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["default"])('.swiper-questions', {
    spaceBetween: 30,
    pagination: {
      ...
      renderCustom: function renderCustom(swiper, current, total) {
        ...
        var totalFormatted = total < 10 ? "0".concat(total) : total;
        return "<span class=\"swiper-questions-pagination-span\">".concat(currentFormatted, "</span>/").concat(totalFormatted);
      }
    },
    navigation: {
  ...
  (0,_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["default"])('.swiper-case', {
    slidesPerView: 2,
    spaceBetween: 30,
    navigation: {
  ...
  (0,_modules_imask__WEBPACK_IMPORTED_MODULE_3__["default"])('[data-js-phone]', '+{998} (00) 000-00-00');
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_4__["default"])('[data-js-modal]', '[data-consultaion-btn]', '[data-js-modal-close]');
  (0,_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["default"])('.swiper-teams', {
    slidesPerView: 4,
    spaceBetween: 30,
    navigation: {
  ...
  (0,_modules_tab__WEBPACK_IMPORTED_MODULE_5__["default"])('[data-js-tab-content]', '[data-js-tab-btn]', '[data-js-tab-parent]');
  (0,_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["default"])('.services-reg-swiper', {
    slidesPerView: 4,
    spaceBetween: 30,
    navigation: {
  ...
  (0,_modules_accordion__WEBPACK_IMPORTED_MODULE_6__["default"])('[data-js-accordion]');
  (0,_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["default"])('.swiper-info-companie-task', {
    slidesPerView: 2,
    spaceBetween: 30,
    navigation: {
  ...
  (0,_modules_swiper__WEBPACK_IMPORTED_MODULE_2__["default"])('.swiper-info-companie-result', {
    slidesPerView: 2,
    spaceBetween: 30,
    navigation: {
  ...
  (0,_modules_search__WEBPACK_IMPORTED_MODULE_7__["default"])('[data-js-services-input]', '[data-js-service]');
  (0,_modules_filter__WEBPACK_IMPORTED_MODULE_8__["default"])('[data-js-filter-parent]', '[data-js-service-filter]', '[data-js-services-btn]');
  (0,_modules_filter_select__WEBPACK_IMPORTED_MODULE_9__["default"])('[data-js-services-select]', '[data-js-service-filter]');
});
}();
/******/ })()
;
